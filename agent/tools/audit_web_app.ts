...
import { runWebAppAudit } from "../lib/web_qa.js";

export default defineTool({
  description:
    "Run a bounded Playwright smoke test against a web app: optional login, same-origin crawl, safe clicks, console/network/page errors, and screenshots.",
